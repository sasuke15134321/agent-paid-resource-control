...
Use this mode before an agent:
- classifies a new user input
- treats a completion report as a new task
- claims information is missing
- reruns a completed task
- explains why it failed
- makes a causal claim about an internal model behavior

Checks:
- Evidence-before-Workflow
- Purpose Drift Check
- Missing-Info Claim Guard
- Causal Claim Guard
- Failure Explanation Receipt

Do not claim missing information until the latest input has been checked.
...
async def agent_json():
    return {
        ...
        "benefits": [
            ...
            "Reduce unsupported missing-info claims",
            "Reduce unsupported causal explanations",
        ...
        "supports": [
            "agent_procurement_gate",
            "agent_quality_boundary",
            "scale_aware_agent_control",
        ],
        "constraints": [
